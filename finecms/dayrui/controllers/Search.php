...
class Search extends M_Controller {
    ...
    public function index() {
		...
		$this->template->display($catid && $category[$catid]['setting']['template']['search'] ? $category[$catid]['setting']['template']['search'] : 'pro_search.html');
    }
    ...
    public function news_search() {
        ...
        $this->template->display($catid && $category[$catid]['setting']['template']['search'] ? $category[$catid]['setting']['template']['search'] : 'news_search.html');
    }
}